         ...
         <div class="container">
            <div class="row no-gutters slider-text align-items-end">
               <div class="col-md-9 ftco-animate pb-5">
                  <p class="breadcrumbs mb-2"><span class="mr-2"><a href="<?php echo site_url();?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="blog.html">Blog <i class="ion-ios-arrow-forward"></i></a></span> <span><?php echo the_title(); ?> <i class="ion-ios-arrow-forward"></i></span></p>
               ...
               <div class="col-lg-8 ftco-animate">
                  ...
                  <div class="about-author d-flex p-4 bg-light">
                     ...
                     <?php
                        ...
                        ?>
                           <img src="<?php echo esc_url( get_avatar_url($author_id)); ?>" alt="<?php get_the_author_meta( 'display_name',$author_id ); ?>" />
                     </div>
                     <div class="desc">
